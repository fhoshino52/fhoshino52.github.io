...
* Optimization of Batch Verification for Pairing Product Equations.
  Fumitaka Hoshino.
...
* Designated Agent Anonymizable Signature
...
* Pseudo-Code Performance Estimation for Pairing-Based Cryptographic Schemes.
...
* Faster Bilinear-Type Conversion.
  Fumitaka Hoshino
...
* Optimal Conversion from Symmetric Pairing-based Scheme to Asymmetric One.
  Fumitaka Hoshino, Masayuki Abe, and Miyako Ohkubo.
...
* Attribute based authenticate key exchange scheme.
...
* On Decentralized Multi-Authority Functional Encryption.
  Fumitaka Hoshino.
...
* Application of Functional Encryption: Key-Insulated Encryption.
...
* Symmetric Pairing based on Asymmetric Pairing.
  Tetsutaro Kobayashi, Fumitaka Hoshino, and Koutarou Suzuki.
...
* Message Dependently Relinkable Ring Signature.
...
* A Point Compression Method for Subfield Curves.
  Fumitaka Hoshino and Tetsutaro Kobayashi.
...
* Efficient GF(3m) Multiplication Algorithm for ηT Pairing.
...
* Security consideration on the signature scheme 3IC-.
...
* On the Invalid Point Attack of Pairing Based Cryptography.
...
* Realtime Receipt Free Schnorr Identification.
  Fumitaka Hoshino, Tetsutaro Kobayashi, and Koutarou Suzuki.
...
* Low-cost RFID privacy protection
...
* Attacks on Implementations of Elliptic Curve Cryptsystems.
...
* Electronic Voting System with MIX-net using Elliptic Curve
...
* More efficient mix-network on permutation networks.
  Fumitaka Hoshino and Masayuki Abe.
