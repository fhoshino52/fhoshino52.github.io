1. [On the Restriction of Asymmetric Pairing based on Symmetric.][2021/scis2021]
  Fumitaka Hoshino.
...
1. Software Implementation of Parallel Elliptic Curve Cryptosystem.
...
1. Electronic Voting Schemes using MIX-net.
...
1. OEF Using a Successive Extension.
...
1. The Fastest ECC Implementations.
...
1. An Electronic Voting Scheme with Revocable Threshold Blind Signatures.
...
1. [More efficient mix-network on permutation networks.][2000/scis2000.pdf]
  Fumitaka Hoshino and Masayuki Abe.
...
1. An Implementation and an Experiment of a Practical and Secure Voting Scheme.
...
1. Elliptic Curve Algorithm on OEF with Frobenius Map.
